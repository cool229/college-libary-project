...
class BOOK_LIST:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.16, rely=0.03, height=31, width=597)
        ...
        self.sbackbutton.configure(width=98)
