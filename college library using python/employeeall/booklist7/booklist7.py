...
def vp_start_gui():
    ...
    root = Tk()
    top = BOOK_LIST (root)
    booklist7_support.init(root, top)
    root.mainloop()
...
def create_BOOK_LIST(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = BOOK_LIST (w)
    booklist7_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class BOOK_LIST:
    def __init__(self, top=None):
        ...
        self.ebackbutton.place(relx=0.45, rely=0.93, height=42, width=98)
        ...
        self.ebackbutton.configure(command=booklist7_support.ebackfunction)
