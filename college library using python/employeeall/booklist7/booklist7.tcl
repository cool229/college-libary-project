...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 1058x722+561+150
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $top.but38 \
        ...
        -text Back 
    vTcl:DefineAlias "$top.but38" "ebackbutton" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab38 \
        -in $top -x 170 -y 20 -width 597 -relwidth 0 -height 31 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.scr39 \
        -in $top -x 0 -y 70 -width 1050 -relwidth 0 -height 588 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but38 \
        -in $top -x 480 -y 670 -width 98 -relwidth 0 -height 42 -relheight 0 \
        -anchor nw -bordermode ignore 
